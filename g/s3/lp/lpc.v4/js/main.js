...
;(function () {
        ...
        class createBLockProduct {
            ...
            constructor($block) {
				...
				this.getCompare = function() {
					...
					$document.on('click', '.lpc-product-compare input:checkbox', function() {
						let $this = $(this),
            ...
            getProducts() {
				...
				// Р¤РѕСЂРјРёСЂСѓРµРј URL РґР»СЏ GET-Р·Р°РїСЂРѕСЃР°
				let url = '/my/s3/xapi/public/?method=folder/getTree&' + params.toString();
				$.ajax({
					url: url,
					success: function(data){
						window.item_f = data.result.items;
						...
						data.result.items.forEach( function( item, index){
							arrayFolder.push(item.folder_id);
						})

						if( !arrayFolder.includes(folderId) ){
							return;
						}


						dataOptionOption.param.search.folder_id = folderId;
						var url = '/my/s3/xapi/public/?method=shop2/getProductsBySearch';
					...
					for (let i = 0; i < itemsFolder.length; i++) {
						if (itemsFolder[i] == item.folder_id) {
							...
							let template = `<li class="lpc-folder-menu-horizontal__item ${lpcMenuView}" data-lp-selector=".lpc-folder-menu-horizontal__item" data-elem-type="container">
								  <a class="lpc-folder-menu-horizontal__link lp-button ${lpcButtons}" href="${link}" data-lp-selector=".lpc-folder-menu-horizontal__link" data-elem-type="text" name="name">
									  ${name}
    ...
    $.each(options.data, function (key, item) {
      ...
      var infowindow = new google.maps.InfoWindow({
        content:
          ...
          '<h3 class="lp-header-title-3" style="margin: 0; padding-bottom: 3px; color: inherit;">' +
          item.name +
          "</h3>" +
          item.desc +
          "</div>",
  ...
  lpc_template.initYandexMaps = function (options, objectListFlag) {
    ...
    var MyBalloonContentLayoutClass = ymaps.templateLayoutFactory.createClass(
      '<div class="baloon-content" style="padding: 0 10px; ">' +
        '<h3 class="lp-header-title-3" style="margin: 0; color: inherit;">$[properties.name]</h3>' +
  ...
  lpc_template.queue.lpcTimer = function ($self) {
    ...
    var formatOut =
      '<div class="lp-ui-timer__item"><div class="lp-ui-timer__item-number lp-header-title-2" data-elem-type="text" name="name" data-lp-selector=".lp-ui-timer__item-number">%d</div><div class="lp-ui-timer__item-text lp-header-text-3" data-elem-type="text" name="name" data-lp-selector=".lp-ui-timer__item-text">' +
      timerDays +
      '</div></div><div class="lp-ui-timer__item"><div class="lp-ui-timer__item-number lp-header-title-2" data-elem-type="text" name="name" data-lp-selector=".lp-ui-timer__item-number">%h</div><div class="lp-ui-timer__item-text lp-header-text-3" data-elem-type="text" name="name" data-lp-selector=".lp-ui-timer__item-text">' +
      timerHours +
      '</div></div><div class="lp-ui-timer__item"><div class="lp-ui-timer__item-number lp-header-title-2" data-elem-type="text" name="name" data-lp-selector=".lp-ui-timer__item-number">%m</div><div class="lp-ui-timer__item-text lp-header-text-3" data-elem-type="text" name="name" data-lp-selector=".lp-ui-timer__item-text">' +
      timerMinutes +
      '</div></div><div class="lp-ui-timer__item"><div class="lp-ui-timer__item-number lp-header-title-2" data-elem-type="text" name="name" data-lp-selector=".lp-ui-timer__item-number">%s</div><div class="lp-ui-timer__item-text lp-header-text-3" data-elem-type="text" name="name" data-lp-selector=".lp-ui-timer__item-text">' +
      timerSeconds +
      "</div></div>";
    var formatEnd =
      '<div class="lp-ui-timer__item"><div class="lp-ui-timer__item-number lp-header-title-2" data-elem-type="text" name="name" data-lp-selector=".lp-ui-timer__item-number">00</div><div class="lp-ui-timer__item-text lp-header-text-3" data-elem-type="text" name="name" data-lp-selector=".lp-ui-timer__item-text">' +
      timerDays +
      '</div></div><div class="lp-ui-timer__item"><div class="lp-ui-timer__item-number lp-header-title-2" data-elem-type="text" name="name" data-lp-selector=".lp-ui-timer__item-number">00</div><div class="lp-ui-timer__item-text lp-header-text-3" data-elem-type="text" name="name" data-lp-selector=".lp-ui-timer__item-text">' +
      timerHours +
      '</div></div><div class="lp-ui-timer__item"><div class="lp-ui-timer__item-number lp-header-title-2" data-elem-type="text" name="name" data-lp-selector=".lp-ui-timer__item-number">00</div><div class="lp-ui-timer__item-text lp-header-text-3" data-elem-type="text" name="name" data-lp-selector=".lp-ui-timer__item-text">' +
      timerMinutes +
      '</div></div><div class="lp-ui-timer__item"><div class="lp-ui-timer__item-number lp-header-title-2" data-elem-type="text" name="name" data-lp-selector=".lp-ui-timer__item-number">00</div><div class="lp-ui-timer__item-text lp-header-text-3" data-elem-type="text" name="name" data-lp-selector=".lp-ui-timer__item-text">' +
	...
	lpc_template.queue.movingPictures = function ($self) {
	    ...
	    if ($block.length) {
	    	setTimeout(function(){
				...
				var marqueeMoveHeight = $marquee.outerHeight();
				$wrapper.height(marqueeMoveHeight);
	
	            var marqueeWidth = $marquee[0].offsetWidth,
	                speed = marqueeSpeed,
	                position = 0,
	                animationFrame,
				...
				if (!s3LP.is_cms) {
		            ...
		            var clonedContent = $marquee.html();
	            ...
	            function move() {
	                ...
	                if (!s3LP.is_cms) {
	                    ...
	                    $marquee.css('transform', 'translateX(' + position + 'px)');
    ...
    setTimeout(function () {
        ...
        document.querySelectorAll('.has_custom_bg').forEach(function (element) {
            ...
            if (textColor > 150) {
                ...
                element.querySelectorAll('[data-elem-type="text" name="name"]').forEach(function (textElement) {
